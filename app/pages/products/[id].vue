    ...
    <div class="mx-auto max-w-7xl px-6 py-8 space-y-12">
      ...
      <div class="grid gap-8 lg:grid-cols-2 lg:items-start">
        ...
        <div v-reveal :data-reveal-delay="'100ms'" class="space-y-4">
          ...
          <p class="text-xl text-gray-800">{{ formatPrice(product?.price || 0) }}</p>
          ...
          <div class="flex items-center gap-3 pt-2">
            <button class="rounded-md px-4 py-2 text-white" style="background-color:#275B32" @click="addToCart()">Add to bag</button>
